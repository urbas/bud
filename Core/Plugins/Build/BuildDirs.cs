...
namespace Bud.Plugins.Build {
  ...
  public static class BuildDirs {
    public static string GetBaseDir(this Configuration buildConfiguration, Scope project) {
      return buildConfiguration.Evaluate(BuildDirsKeys.BaseDir.In(project));
    }

    public static string GetBudDir(this Configuration buildConfiguration, Scope project) {
    ...
    public static string GetOutputDir(this Configuration buildConfiguration, Scope project) {
      return buildConfiguration.Evaluate(BuildDirsKeys.OutputDir.In(project));
    }

    public static string GetDefaultOutputDir(this Configuration ctxt, Scope scope) {
    ...
    /// <param name="projectBaseDir">The root directory of the project being built.</param>
    public static string GetBuildConfigCacheDir(this Configuration buildConfiguration, Scope project) {
      return buildConfiguration.Evaluate(BuildDirsKeys.BuildConfigCacheDir.In(project));
    }

    public static string GetDefaultBuildConfigCacheDir(this Configuration ctxt, Scope scope) {
