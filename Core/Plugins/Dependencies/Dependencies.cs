...
namespace Bud.Plugins.Dependencies {
  public static class Dependencies {
    ...
    public static Plugin ToDependency(this Key scope) {
    ...
    public static Settings AddDependency(this Settings settings, Key dependent, ScopeDependency dependency) {
      return settings.Modify(DependenciesKeys.ScopeDependencies.In(dependent), dependencies => dependencies.Add(dependency));
    }

    public static ImmutableList<ScopeDependency> GetDependencies(this EvaluationContext context, Key inScope) {
      return context.Evaluate(DependenciesKeys.ScopeDependencies.In(inScope));
    }

    public static Task<ImmutableList<ResolvedScopeDependency>> ResolveDependencies(this EvaluationContext context, Key inScope) {
