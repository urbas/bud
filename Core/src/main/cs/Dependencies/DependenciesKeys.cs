...
namespace Bud.Dependencies {
  public static class DependenciesKeys {
    ...
    public static readonly ConfigKey<string> FetchedDependenciesDir = new ConfigKey<string>("fetchedDir").In(Dependencies);
    public static readonly ConfigKey<string> FetchedDependenciesListFile = new ConfigKey<string>("fetchedDependenciesListFile").In(Dependencies);
