...
namespace Bud.Dependencies {
  public static class DependenciesSettings {
    ...
    public static Setup AddDependency(InternalDependency internalDependency,
      ...
      return SetupUtils.Merge(AddDependency(internalDependency, shouldUseInternalDependency),
    ...
    public static Setup AddDependency(InternalDependency dependency, Predicate<IConfig> conditionForInclusion = null) {
      return SetupUtils.Merge(DependenciesKeys.InternalDependencies.Init(ImmutableList<InternalDependency>.Empty),
    ...
    public static Setup AddDependency(ExternalDependency dependency, Predicate<IConfig> conditionForInclusion = null) {
      return settings => settings.Add(DependenciesKeys.ExternalDependencies.Init(ImmutableList<ExternalDependency>.Empty),
                                      ...
                                      DependenciesKeys.Dependencies.Init(DependenciesImpl))
                                 .AddGlobally(DependenciesKeys.ExternalDependenciesKeys.Modify((ctxt, oldValue) => oldValue.Add(settings.Scope / DependenciesKeys.ExternalDependencies)));
    }
