...
namespace Bud.IO {
  public static class Files {
    ...
    public static IFiles ExtendWith(this IFiles files, IFilesObservatory filesObservatory, string sourceDir, string fileFilter)
      => files.ExtendWith(new RecursiveDirFiles(filesObservatory, sourceDir, fileFilter));
