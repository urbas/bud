...
namespace Bud.IO {
  public class WatchedResourcesTest {
    ...
    public void Equals_to_the_enumeration_of_resources() {
      var watchedResources = new WatchedResources<int>(resources, Observable.Empty<object>());
    ...
    public void ExpandWith_produces_a_concatenated_enumeration() {
      var watchedResources = new WatchedResources<int>(resources, Observable.Empty<object>());
      var otherWatchedResources = new WatchedResources<int>(otherResources, Observable.Empty<object>());
    ...
    public void Does_not_subscribe_to_the_watcher_if_not_observing_past_first_notification() {
      var resourceWatcher = new Mock<IObservable<object>>(MockBehavior.Strict).Object;
    ...
    public void Produces_watch_notifications_from_the_given_watcher() {
      var singleNotificationWatcher = Observable.Return("");
    ...
    [Test]
    public void ExpandWith_concatenates_watch_notifications() {
      var singleNotificationWatcher = Observable.Return("");
