...
namespace Bud.IO {
  public class FilesDiffTest {
    ...
    public void Initially_all_files_are_added() {
      ...
      var diff = FilesDiff.ToFilesDiffObservable(filesUpdates).ToEnumerable().First();
    ...
    public void List_newly_added_files() {
      ...
      var diff = FilesDiff.ToFilesDiffObservable(filesUpdates).ToEnumerable().Last();
    ...
    public void Changed_file() {
      ...
      var diff = FilesDiff.ToFilesDiffObservable(filesUpdates, fileTimestamps.Object).ToEnumerable().Last();
      Assert.IsEmpty(diff.RemovedFiles);
      Assert.IsEmpty(diff.AddedFiles);
