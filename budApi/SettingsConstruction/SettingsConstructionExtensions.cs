...
namespace Bud.SettingsConstruction {
  public static class SettingsConstructionExtensions {
    ...
    public static Settings Initialize<T>(this Settings existingSettings, TaskKey<T> key, Func<BuildConfiguration, T> task) {
      return existingSettings.Add(new InitializeTask<T>(key, task));
    }
