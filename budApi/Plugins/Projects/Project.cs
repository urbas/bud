...
namespace Bud.Plugins.Projects {
  ...
  public static class Project {
    ...
    public static SettingKey Key(string id) {
      return new SettingKey(id).In(ProjectKeys.Projects);
    }

    public static ImmutableHashSet<SettingKey> GetListOfProjects(this EvaluationContext buildConfiguration) {
    ...
    public static string GetDefaultBudDir(this EvaluationContext ctxt, ISettingKey scope) {
    ...
    public static string GetDefaultOutputDir(this EvaluationContext ctxt, ISettingKey scope) {
    ...
    public static string GetDefaultBuildConfigCacheDir(this EvaluationContext ctxt, ISettingKey scope) {
