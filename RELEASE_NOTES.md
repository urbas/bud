...
- __New feature__: Introduced the `@watch` macro. This macro watches sources in the `src` folder and evaluates tasks specified in the command line. Example of usage:
