...
namespace Bud.Reactive {
  public class ObservableResults {
    ...
    private static readonly MethodInfo ObservableWaitMethodInfo = typeof(Observable).GetMethod(nameof(Observable.Wait));
    private static readonly MethodInfo ObservableTakeMethodInfo = typeof(Observable).GetMethods()
